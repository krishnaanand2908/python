...
salamenderh = ("सैलामैंडर उभयचरों का एक समूह है जो आमतौर पर उनकी छिपकली जैसी उपस्थिति की विशेषता होती है, जिसमें पतले शरीर, कुंद थूथन, शरीर के समकोण पर प्रक्षेपित छोटे अंग और लार्वा और वयस्कों दोनों में एक पूंछ की उपस्थिति होती है। सभी दस मौजूदा समन्दर परिवारों को यूरोडेल के क्रम में एक साथ समूहीकृत किया गया है")
